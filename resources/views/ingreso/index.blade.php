        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <br><br>
                    <b><span> Balance General de Ingresos {{ $mes }} 20{{ $año }}: </span></b>
                    <div class="grid grid-cols-4 gap-4">
                        <div class="mt-6 text-gray-500">
                            <label>Total Año: </label>
                            <input type="text" disabled value="{{$ingresosAnual}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div class="mt-6 text-gray-500">
                ...
                <br><br>
                <b><span> Ingresos por Categoria {{  $mes }} del 20{{  $año }}: </span></b>
                <div class="relative overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            @foreach ($ingresosCategorias as $dato)
                ...
                <br><br>
                <p class="text-lg text-gray-900 dark:text-white">Ingresos del 20{{ $año }}</p>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <a href="{{ route('ingreso.edit', $registro->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Editar </a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
