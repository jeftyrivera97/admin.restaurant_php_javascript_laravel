                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <div class="mt-6 text-gray-500">
                            ...
                            <input type="text" disabled value=" {{$pBalanceAnual}}%" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                    </div>
                    <br><br>
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <div class="mt-6 text-gray-500">
                            <label>Porcentaje de Balance: </label>
                            <input type="text" disabled value=" {{$pBalanceMes}}%" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                    </div>
                </div>
            </div>
