        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <x-nav-link :href="url('/empleado/create')">
                    ...
                    <br><br>
                    <p class="text-lg text-gray-900 dark:text-white">Lista de Empleados</p>
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                      <a href="{{ route('empleado.edit', $empleado->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Editar </a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
