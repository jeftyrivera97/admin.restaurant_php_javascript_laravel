        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <br><br>
                    <b><span> Balance General de Compras {{ $mes }} 20{{ $año }}: </span></b>
                    <div class="grid grid-cols-2 gap-2">
                        <div class="mt-6 text-gray-500">
                            <label>Total Año: </label>
                            <input type="text" disabled value="{{$comprasAnual}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div class="mt-6 text-gray-500">
                    ...
                    <div class="grid grid-cols-4 gap-4">
                        <div class="mt-6 text-gray-500">
                            ...
                            <input type="text" disabled value="{{$comprasContado}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div class="mt-6 text-gray-500">
                            <label>Compras por Pagar: </label>
                            <input type="text" disabled value="{{$comprasCredito}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div class="mt-6 text-gray-500">
                    ...
                    <br>
                    <b><span> Compras por Proveedor {{  $mes }} del 20{{  $año }}: </span></b>
                        <div class="relative overflow-x-auto">
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    @foreach ($comprasProveedores as $c)
                    ...
                    <br><br>
                    <b><span> Compras por Categoria {{  $mes }} del 20{{  $año }}: </span></b>
                    <div class="relative overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                            ...
                            <tbody>
                                @foreach ($comprasCategorias as $c)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $c['descripcion'] }}
                                    </th>
